...
void WiFiManager::setupConfigPortal() {
  ...
  server->on("/", std::bind(&WiFiManager::handleRoot, this, false));
  ...
  server->on("/fwlink", std::bind(&WiFiManager::handleRoot, this, true));  //Microsoft captive portal. Maybe not needed. Might be handled by notFound handler.
...
void WiFiManager::handleRoot(bool internetConnected) {
